...
public class XpathExample3 extends BaseTest {
	...
	public void xpathExample() {
		 ...
		 * 3. de la span, fac o referinta catre copilul lui span <bdi> si valoarea acestui copil --> //span[@class='price']/span[bdi='$10.20'])
		 * 4. pentru ca acum gasesc 5 elemente si vreau sa specific elementul cu numarul 2, aleg sa folosesc index --> //span[@class='price']/span[bdi='$10.20'])[2]
		 ...
		 * 5. urc cu .. un nivel mai sus unde gasesc o relatie de rudenie de tip siblings --> //span[@class='price']/span[bdi='$10.20'])[2]/..
		 * 6.pentru ca vreau sa iau fratele/sora de deaspura elementului unde ma aflu aleg sa urc cu preceding-sibling pe element
		 * -->(//span[@class='price']/span[bdi='$10.20'])[2]/../preceding-sibling::div[@class='star-rating']
		 */
		
		
		// in shop, butoanele de navighezi pe pagini
		//---> //ul/li[*>1]
		/* Gaseste toate paginile care au valoarea mai mare ca 1 (*>1) indiferent de tagnameul lor (*)
		 * 
		 */
